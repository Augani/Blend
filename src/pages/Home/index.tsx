  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <main className="w-full grid grid-rows-2 gap-4">
        ...
        <section className=" place-items-center flex flex-col  items-center">
          <h1 className="lg:text-8xl text-4xl font-bold tracking-widest text-center uppercase leading-snug ">
            Stay alive! <br /> Buy more gems! <br /> 20% discount
          </h1>
          <hr className="my-10 border-gray-600" />
          <Button className="text-gray-50 font-semibold text-xl rounded-sm h-12 lg:w-1/4 w-4/5 shadow-xl transform duration-200 hover:scale-105 justify-center flex flex-row items-center hover:bg-red-600 bg-red-500 ">
            <p className="text-lg mr-2 font-semibold tracking-wider">Buy gems</p>
            <svg
        ...
        <div id="store" className="bg-gray-800 w-full flex flex-col items-center">
            <h1 className="text-2xl tracking-wider font-bold text-gray-50">Store</h1>
        </div>
